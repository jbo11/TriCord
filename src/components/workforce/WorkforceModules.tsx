...
function HrPage({ workspaceId, userId, role, profiles, memberships, capabilities, theme, onNotice }: WorkforceProps) {
  ...
  return <><ModuleFrame icon={BriefcaseBusiness} title="Employee Records" subtitle={canManage ? 'People, leave, documents, and performance' : 'Your employee profile and leave'} theme={theme} scroll={tab !== 'people'}>
