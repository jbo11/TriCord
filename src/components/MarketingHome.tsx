...
const features = [
  ...
  { icon: Clock3, title: 'Workforce', body: 'Turn on attendance, employee records, and payroll-preparation records only when your Hub needs them.', preview: 'workforce' },
  ...
  { icon: Sparkles, title: 'Reports', body: 'See tasks, activity, room progress, and optional workforce records in one view.', preview: 'reports' },
] as const;
...
function UseCases() {
  const useCases = [['Individuals', 'Capture client requests, personal projects, repeatable processes, and daily work in a calmer place than chat.'], ['Teams', 'Coordinate projects, support work, sales follow-ups, onboarding, and internal operations without scattering context.'], ['Organizations', 'Give leaders visibility across rooms, tasks, procedures, and optional workforce tools as the team grows.']];
...
const legalContent = {
  ...
  privacy: {
    ...
    sections: [
      ...
      ['Role-based access', 'TriCord is designed around Hubs, Rooms, roles, and permissions. Owners and authorized Admins may access business records and enabled workforce records needed to operate a Hub. Members and Guests should only see the content and records permitted for their role.'],
