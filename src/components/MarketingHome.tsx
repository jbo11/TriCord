  ...
  return (
    <section className="bg-[#F7F5F2] py-20 sm:py-24">
      <div className="mx-auto max-w-7xl space-y-20 px-4 sm:px-6 lg:px-8">
        ...
        <ProductBand eyebrow="Optional business modules" title="Add operational records only when your team needs them." body="Attendance tracking, employee records, payroll-preparation records, recruitment, and CRM can be enabled by the Hub Owner when those workflows belong in TriCord. Core collaboration stays simple by default." reverse={false}><WorkforceMockup /></ProductBand>
